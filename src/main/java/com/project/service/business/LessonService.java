...
public class LessonService {
    ...
    // classın dışında bu methodu kullanamayacağız
    ...
    // buradaki kodda normalden biraz farklı olarak yaptık if ve else ile bunu onceden yaptığımız gibide yapabilirdik
    ...
    public Set<Lesson> getAllLessonByLessonId(Set<Long> idSet) {
        ...
        // bu method ya herro ya merro olarak çalışıyor olanları gönder olamayanlar için excep fıralt gibi olmuyor onun için yeni method yazmak lazım 
    }
